...
import { opponentMakesMove, userMakesMove } from '../redux/dominoSliceOnline'
...
const DropPlaceholderOnline = ({
  ...
  const dispatchMoves = () => {
    ...
    /* setIsLoading(true);
    socket.connect();
    socket.timeout(5000).emit('events', JSON.stringify(droppedTile), () => {
      setIsLoading(false);
    }); */

    /* setTimeout(() => {
      dispatch(opponentMakesMove())
    }, 600) */
  }
...
export default DropPlaceholderOnline
